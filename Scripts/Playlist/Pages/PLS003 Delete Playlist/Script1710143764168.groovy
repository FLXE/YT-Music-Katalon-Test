...
WebUI.callTestCase(findTestCase('Playlist/Step Definition/PLS003/User tap on Delete playlist'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Playlist/Step Definition/PLS003/User tap on Delete to confirm deleting'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Playlist/Step Definition/PLS003/Verify playlist deleted'), [:], FailureHandling.STOP_ON_FAILURE)
